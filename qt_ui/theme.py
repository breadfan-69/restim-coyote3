...
def _build_dark_palette():
    """Build a dark QPalette to complement the dark stylesheet.

    Fusion style paints *some* widget backgrounds from the palette rather than
    the stylesheet (tab-widget panes, plain QWidget backgrounds inside
    QTabWidget, etc.).  Setting the application palette ensures that every
    surface that Fusion draws directly also uses dark colours.
    """
    from PySide6.QtGui import QPalette
    from PySide6.QtCore import Qt
    palette = QPalette()
    palette.setColor(QPalette.ColorRole.Window,          QColor("#3d3d3d"))
    palette.setColor(QPalette.ColorRole.WindowText,      QColor("#e0e0e0"))
    palette.setColor(QPalette.ColorRole.Base,            QColor("#4d4d4d"))
    palette.setColor(QPalette.ColorRole.AlternateBase,   QColor("#3d3d3d"))
    palette.setColor(QPalette.ColorRole.ToolTipBase,     QColor("#4d4d4d"))
    ...
    palette.setColor(QPalette.ColorRole.Link,            QColor("#0d47a1"))
    palette.setColor(QPalette.ColorRole.Highlight,       QColor("#0d47a1"))
