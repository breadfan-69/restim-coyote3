...
coyote_channel_a_strength_max = Setting("coyote/channel_a_strength_max", 200, int)
coyote_channel_a_freq_min = Setting("coyote/channel_a_freq_min", 70, int)
coyote_channel_a_freq_max = Setting("coyote/channel_a_freq_max", 200, int)
coyote_channel_b_strength_max = Setting("coyote/channel_b_strength_max", 200, int)
coyote_channel_b_freq_min = Setting("coyote/channel_b_freq_min", 30, int)
coyote_channel_b_freq_max = Setting("coyote/channel_b_freq_max", 200, int)
