...
import coyote_plugin.settings as ui_settings
...
from coyote_plugin.device.types import CoyoteParams, CoyotePulse, CoyotePulses, CoyoteStrengths, ConnectionStage
